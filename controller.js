...
import puppeteer from "puppeteer-extra"; // Enhanced version of Puppeteer for additional functionality
...
const mapScrapper = asyncHandler(async (req, res) => {
  console.log("here");
  ...
  const { country, cityName, keyword } = req.body;
